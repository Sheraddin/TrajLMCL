...
TrajLMCL project using a GPT-2 backbone (via LoRA fine-tuning) for road-network data. The model is trained incrementally across temporal data slices using knowledge distillation.
